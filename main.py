...
async def invite_voice_command(
    ...
    try:
        ...
        # Создаем прямую ссылку на голосовой канал (как в логах)
        ...
        # Добавляем ссылку прямо в embed (работает как в логах)
        invite_embed.add_field(
        ...
        try:
            # Отправляем одно сообщение с приглашением и ссылкой
